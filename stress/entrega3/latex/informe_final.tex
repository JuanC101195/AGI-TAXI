...
VM tiene un margen muy superior al previsto inicialmente. La trazabilidad
queda garantizada mediante archivos de configuraci\'on, escenarios XML,
scripts de monitoreo y CSVs de evidencia publicados en el repositorio
del proyecto.
\end{abstract}
